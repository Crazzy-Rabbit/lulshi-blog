---
title: GWFM结果可视化
description: A tool to visulaize the results of GWFM
tags: [R, code]
...
:::tip
Locus plot for [GWFM](https://gctbhub.cloud.edu.au/software/gctb/#Genome-wideFine-mappinganalysis) (genome wide fine mapping)
:::

![GWFM](./images/GWFM.png)
